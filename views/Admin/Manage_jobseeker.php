...
<head>
    ...
    />
    <script defer src="<?php echo URL ?>views/JS/Admin/Manage_jobseekers.js">
    ...
    <div class="right-division">
        ...
        <div class="search-toggle">
            ...
            <div class="search-jobseeker">
                <input type="text" name="search-jobseekers" id="search-jobseekers" placeholder="Search jobseekers"
        ...
        <!-- add jobseekers -->
        <div class="add-jobseekers">
            <button id = "add-button"><span class="plus">+</span>Add jobseekers</button>
        </div>

        

        <!-- table -->
        <div class="Table" id="jobseeker_table">
            <table>
                <thead>
                <tr id="columnTopic">
                    <th>ID</th>
