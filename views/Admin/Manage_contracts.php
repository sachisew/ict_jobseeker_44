...
<head>
    ...
    />
    <script defer src="<?php echo URL ?>views/JS/Admin/Manage_contracts.js">
...
<div class="main-container">
    ...
    <div class="right-division">
        ...
        <div class="add-contracts">
            <button id = "add-button"><span class="plus">+</span>Add contracts</button>
        </div>
        ...
        <!-- table -->
        <div class="Table" id="contract_table">
            <table>
                <thead>
                <tr id="columnTopic">
                    <th>contract ID</th>
                    <th>Title</th>
                    <th>Cprovider Name</th>
