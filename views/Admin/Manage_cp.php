...
<head>
    ...
    />
    <script defer src="<?php echo URL ?>views/JS/Admin/Manage_cp.js">
...
<div class="main-container">
    ...
    <div class="right-division">
        ...
        <div class="search-toggle">
            ...
            <!-- search part -->
            <div class="search-cprovider">
                <input type="text" name="search-cproviders" id="search-cproviders" placeholder="Search Contract Providers"
        ...
        <!-- add cproviders -->
        <div class="add-cproviders">
            <button id = "add-button"><span class="plus">+</span>Add CProviders</button>
        </div>

        

        <!-- table -->
        <div class="Table" id="cprovider_table">
            <table>
                <thead>
                <tr id="columnTopic">
                    <th>ID</th>
                    <th>Email</th>
                    <th>Contract Provider Name</th>
